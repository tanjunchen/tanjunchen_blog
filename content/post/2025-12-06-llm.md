...
subtitle:   "从 Static Batching、Continuous Batching 到 PagedAttention 与 PD 分离的推理演进"
description: "本文系统梳理大模型推理架构演进的核心节点：从 Static Batching 到 Continuous Batching（vLLM/SGLang 核心机制），再到 PagedAttention 的 KV Cache 显存管理、Chunked Prefill 以及 Prefill/Decode 分离架构，深入剖析优化吞吐与降低时延的关键工程实践。"
author: "tanjunchen"
date: 2025-12-06
published: true
tags:
